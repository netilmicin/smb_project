		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SMB",
									"targetURL": "#smbproject10-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"smbproject10-display": {
								"semanticObject": "smbproject10",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=smbproject1.0",
									"url": sap.ui.require.toUrl("smbproject1/0")
								}
							}
						}
					}
